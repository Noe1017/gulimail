    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.schedName) {
            this.$http({
              url: this.$http.adornUrl(`/ware/qrtzsimproptriggers/info/${this.dataForm.schedName}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/ware/qrtzsimproptriggers/${!this.dataForm.schedName ? 'save' : 'update'}`),
              method: 'post',
